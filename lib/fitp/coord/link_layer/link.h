 ...
 * @return void
 */
extern void LINK_join_request_recived(uint8_t signal_strenght, uint8_t* from, uint8_t* payload, uint8_t len);
 ...
 * @param payload data recived in join response
 * @param len lenght of data
 * @return false if coord->ed bypass buffer is full else true
 */
